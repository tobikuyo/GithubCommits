...
class CommitsTableViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    func loadSavedData() {
        if fetchedResultsController == nil {
            ...
            let sortByDate = NSSortDescriptor(key: "author.name", ascending: false)
